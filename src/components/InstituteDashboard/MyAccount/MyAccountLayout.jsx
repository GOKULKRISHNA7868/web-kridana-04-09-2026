...
const computePercent = (data) => {
  ...
  const checks = [
    Boolean(data.instituteName && data.profileImageUrl && data.description),
...
const AcademyProfileWorkspace = ({ instituteId, actor = null }) => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setForm((prev) => ({
          ...
          founderBackground: d.founderBackground || d.designation || "",
          designation: d.designation || "",
          description: d.description || "",
          yearFounded: d.yearFounded ? String(d.yearFounded) : "",
          organizationType: d.organizationType || "Sports Academy",
  ...
  const syncProgramsFromSports = () =>
    flattenSports(form.categories, form.sportDetails).map((sport) => {
      ...
      return {
        ...
        duration: m.classDuration ? `${m.classDuration} mins` : prev?.duration || "",
    ...
    try {
      ...
      await setDoc(
        doc(db, "institutes", instituteId),
        {
          ...
          designation: form.founderBackground || form.designation,
      ...
      if (actor?.trainerUid) {
        await updateDoc(doc(db, "institutes", instituteId), {
          ...
          lastEditedSection: "Academy Profile",
        ...
        await logStaffAction({
          ...
          details: "Updated academy profile",
        });
      }
        ...
        <div className="max-w-7xl mx-auto p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-6 pb-16">
          ...
          <div className="space-y-5 min-w-0">
            ...
            <Section
              ...
              subtitle="Public name, logo and academy story"
              done={Boolean(
                form.instituteName && form.profileImageUrl && form.description,
              )}
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-[72px] h-[72px] rounded-full border border-slate-200 overflow-hidden bg-slate-50 flex items-center justify-center shrink-0">
                    {form.founderPhotoUrl ? (
                      <img
                        src={form.founderPhotoUrl}
                        alt=""
                        className="w-full h-full object-cover"
                      />
                    ) : (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="hidden"
                      onChange={(e) =>
                        handleUpload(e.target.files?.[0], "founder")
                      }
                    />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Field label="Academy name" required>
                  <input
                    ...
                    placeholder="e.g. Champion Sports Academy"
                  />
                </Field>
              ...
              <Field
                ...
                hint={`${(form.founderBackground || "").length}/500`}
              >
                <textarea
                  className={areaCls}
                  rows={3}
                  ...
                  onChange={(e) =>
                    setField("founderBackground", e.target.value)
                  }
                  placeholder="Short background about the founder"
                />
              </Field>
              ...
              >
                <textarea
                  ...
                  placeholder="What makes your academy special?"
                />
              </Field>
            ...
            <Section
              ...
              number={2}
              title="Location"
              subtitle="Help parents find your academy"
            ...
            {/* 3 Sports + fees per sport (accordion) */}
            <Section
              id="section-sports"
              number={3}
              title="Sports, Programs & Fees"
              subtitle="Add each sport, then set its fees in the same card — no confusion"
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2 px-4 py-3">
                        ...
                        <button
                          type="button"
                          onClick={() => removeSport(sport.category, sport.name)}
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {LEVEL_OPTIONS.map((opt) => (
                                <Chip
                                  key={opt}
                                  active={(m.trainingLevels || []).includes(opt)}
                                  onClick={() =>
                                    updateSportMeta(sport.category, sport.name, {
              ...
              <div className="pt-2 border-t border-slate-100 space-y-4">
                ...
                <Field label="Refund policy">
                  <textarea
                    ...
                    placeholder="Explain refund / pause rules for parents"
                  />
                </Field>
              </div>
            </Section>
            ...
            {/* 6 Achievements — own section beside fees/profile flow */}
            <Section
                  ...
                  >
                    <Field label="Title">
                      <input
                        ...
                        placeholder="e.g. Karnataka State Karate Championship"
                      />
                    </Field>
          ...
          {/* SIDE PREVIEW — read only, no overlays */}
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-slate-600 mt-3 line-clamp-3">
                    {form.description || "Academy story appears here."}
                  </p>
                  {sportsList.length > 0 ? (
...
const MyAccountLayout = ({ instituteId: overrideId, actor = null } = {}) => {
  ...
  return (
    <AccountScopeProvider instituteId={instituteId} actor={actor}>
      <AcademyProfileWorkspace instituteId={instituteId} actor={actor} />
