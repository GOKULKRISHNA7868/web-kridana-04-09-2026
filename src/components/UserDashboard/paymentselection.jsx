      ...
      <div className="w-full max-w-md md:max-w-2xl xl:max-w-3xl bg-[#FBF9F7] rounded-3xl shadow-lg border border-orange-100 overflow-hidden">
        <div className="px-4 py-5 sm:px-6 md:px-8 md:py-7">
          ...
          {Array.isArray(items) && items.length > 0 ? (
            <div className="mb-5 rounded-2xl border border-orange-100 bg-white p-4 space-y-3">
              ...
              {items.map((item, idx) => (
                <div
                  ...
                  className="text-sm border-b border-slate-100 last:border-0 pb-2.5 last:pb-0"
                >
                  ...
                  {(item.extras || []).map((ex, xi) => (
                    ...
                    >
                      <span className="truncate">
                        Extra{ex.note || ex.label ? ` · ${ex.note || ex.label}` : ""}
                      </span>
